package com.ly.sys.common.web.controller.permission;
...
import com.ly.common.json.MessageUtils;
...
public class PermissionList implements Serializable {
   ...
   * 
   */
  private static final long   serialVersionUID    = -8107044950536178497L;
