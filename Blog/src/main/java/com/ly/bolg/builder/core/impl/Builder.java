package com.ly.bolg.builder.core.impl;
...
import com.ly.bolg.builder.util.CommonUtil;
import com.ly.bolg.builder.util.VelocityUtil;
import com.ly.bolg.builder.util.XmlUtil;
/**
 * @Description:  
 * @User: mtwu
...
public class Builder implements IBuilder {
	...
	public void buildeJavaBean(){
		try {
			agt.setTemplate(maker.getTempletPath()+"/Entity.vm","utf-8");
			...
			agt.put("idType", maker.getIdType());
			agt.put("maker", maker);
	...
	public void buildeQueryJavaBean(){
		try {
			agt.setTemplate(maker.getTempletPath()+"/QueryModel.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
	...
	public void buildeRepository() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/IbatisDao(interface).vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("entityPackageName", maker.getEntityPackageName());
			agt.put("author", maker.getAuthor());
	...
	public void buildeDAOImpl() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/DAOImpl.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("daoPackageName", maker.getDaoPackageName());
	...
	public void buildeIBatis() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/Ibatis.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("tableName", maker.getTableName());
	...
	public void buildeIService() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/IService.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("entityPackageName", maker.getEntityPackageName());
	...
	public void buildeServiceImpl() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/ServiceImpl.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("entityPackageName", maker.getEntityPackageName());
	...
	public void buildeController() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/Controller(mybatis).vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("list", list);
	...
	public void buildeForm() {
		try {
			agt.setTemplate(maker.getTempletPath()+"/Form.vm","utf-8");
			agt.put("packageName", maker.getPackageName());
			agt.put("entityName", maker.getEntityName());
			agt.put("author", maker.getAuthor());
			agt.put("list", copyList);
