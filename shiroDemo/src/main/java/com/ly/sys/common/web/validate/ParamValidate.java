...
public class ParamValidate {
  ...
  /**
   * 手机号码正则表达式=^1(3[0-9]|4[57]|5[0-35-9]|8[0-9]|7[0-9])\\d{8}$
   */
  ...
  public static final String IDCARD="((11|12|13|14|15|21|22|23|31|32|33|34|35|36|37|41|42|43|44|45|46|50|51|52|53|54|61|62|63|64|65)[0-9]{4})" +
     ...
     * 正则 ^[-+]?(/d+(/./d*)?|/./d+)([eE]([-+]?([012]?/d{1,2}|30[0-7])|-3([01]?[4-9]|[012]?[0-3])))?$
      ...
      * 中文数字字母
      */
     public final static String NUM_CHN_ENG = "^([A-Za-z]|[0-9]|[\u4E00-\u9FA5]){0,}$";
...
////------------------验证方法     
  ...
  /**
   * 判断字段是否为中文数字或字母 符合返回ture
   * @param str
   * @return boolean
   */
  public static  boolean isEng_Num_CHN(String str) {
    return Regular(str,NUM_CHN_ENG) ;
  }
  /**
   * 判断字段是否超长
   ...
   * @return boolean
   */
  public static  boolean isBetweenLengOut(String str,int minLeng,int maxLeng) {   
   if(str.length()>maxLeng||str.length()<minLeng){
     return true;
   }
   return false;
  }
   ...
   * @return boolean
   */
  public static  boolean isHasStrSpecial(String str) {
    Pattern p = Pattern.compile(STR_SPECIAL);
    Matcher m = p.matcher(str);
    if(m.find()){
      return true;
  ...
  public static  boolean isScientific(String str){
    if(StrisNull(str))
      return false; 
    return Regular(str,ParamValidate.SCIENTIFIC_A);
  } 
  public static void main(String[] args) {
      boolean rt  =  isENG_NUM("1_d");
