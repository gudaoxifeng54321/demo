...
public class ExcelExportUtil {
    ...
    public void export(String sheetName, NumberFormat nf, String[][] content,
            String[] mergeInfo, OutputStream os, String row, String col) throws WriteException {
    ...
    public void exportFormatExcel(String[][] content, String sheetName,
            OutputStream os,Integer[] widths) throws WriteException {
        if (VerifyUtil.isNullObject(content, os) || VerifyUtil.isNull2DArray(content)) {
            return;
        }
        // 默认名称
    ...
    public void exportFormatExcel(Map<String, String[][]> content,
            String[] salary_name_array, String sheetName, OutputStream os) throws WriteException
             {
    ...
    public static void main(String[] args) {
        ...
        String[][] content = new String[][] { { "11", "第一列", "22", "第三列" },
                { "第一行", "aa", "2.00", "22" }, { "第二行", "bb", "3.01", "32" },
                { "第三行", "cc", "4.00", "41" } };
        try {
            OutputStream os = new FileOutputStream("D:/test4.xls");
            // ee.export(null,null, content,null, os);
            ee.export(null, null, content,null, os, null, null);
        } catch (Exception e) {
